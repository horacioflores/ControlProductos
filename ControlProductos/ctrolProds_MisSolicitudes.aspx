<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="ctrolProds_MisSolicitudes.aspx.cs" Inherits="ControlProductos.ctrolProds_MisSolicitudes" %>
            ...
            <Groups>
                ...
                <ContentTemplate>
                    ...
                    <table style="float: right; width: 20%" class="OptionsTable BottomMargin">
                            <tr>
                                <td>
                                    <dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" Width="100%" HeaderText="+ Options" Theme="Metropolis" Visible="true" >
                                    <PanelCollection>
                                        <dx:PanelContent>
                                        <div>
                                            <table>
    ...
    <div id="Detalle" runat="server">
        ...
        <dx:ASPxGridView ID="xgrdProds" runat="server" AutoGenerateColumns="False" Width="100%" Font-Names="Segoe UI"
            ...
            <Columns>
                ...
                <dx:GridViewDataColumn FieldName="ctrlProdsID" VisibleIndex="2"  Caption="" Width="30px">
                      <DataItemTemplate>
