<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="CatUM.aspx.cs" Inherits="ControlProductos.CatUM" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="Busqueda" runat="server">
                    <dx:ASPxNavBar ID="ASPxNavBar2" runat="server" Theme="Metropolis" Width="100%" 
                        Font-Bold="False">
                        <Groups>
                            <dx:NavBarGroup Text="Unit of measurement\ Filters">
                                    <ContentTemplate>
    ...
    <div id="Detalle" runat="server">
         <dx:ASPxGridView ID="xgrdUmedida" runat="server" AutoGenerateColumns="False" Width="100%" Font-Names="Segoe UI"
                    KeyFieldName="UMedidaID" oncustomcallback="xgrdUmedida_CustomCallback" ClientInstanceName="grid"
                    onrowdeleting="xgrdUmedida_RowDeleting" onrowvalidating="xgrdUmedida_RowValidating" onrowinserting="xgrdUmedida_RowInserting" 
                    onrowupdating="xgrdUmedida_RowUpdating" OnHtmlDataCellPrepared="xgrdUmedida_HtmlDataCellPrepared" Theme="Metropolis">
                    <Columns>
                        <dx:GridViewDataTextColumn FieldName="UMedidaID" Visible="false" Caption="Identifier" VisibleIndex="0">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Name="CheckID" VisibleIndex="1" Width="30px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="Codigo" VisibleIndex="2" Caption="Code" Width="20%">
                        </dx:GridViewDataTextColumn>                     
                        <dx:GridViewDataTextColumn FieldName="Nombre" VisibleIndex="3" Caption="Name" Width="50%">
                        </dx:GridViewDataTextColumn>
                    </Columns>
                                            ...
                                            <table style="width:100%; padding-left:10px; padding-right:10px; padding-bottom:20px">
                                                <tr style="height:40px">
                                                    <td style="height:40px; padding-right:10px; text-align:right" colspan="2">
                                                        <dx:ASPxLabel runat="server" ID="ASPxLabel3" Text="Unit of Measure register" Font-Size="13pt" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                    </td>
                                                </tr>
                                                <tr>
