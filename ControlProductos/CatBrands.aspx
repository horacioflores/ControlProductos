<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="CatBrands.aspx.cs" Inherits="ControlProductos.CatBrands" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="Busqueda" runat="server">
        <dx:ASPxNavBar ID="ASPxNavBar2" runat="server" Theme="Metropolis" Width="100%" Font-Bold="False">
            <Groups>
                <dx:NavBarGroup Text="Brands \ Filters">
                        <ContentTemplate>
    ...
    <div id="Detalle" runat="server">
         <dx:ASPxGridView ID="xgrdMarca" runat="server" AutoGenerateColumns="False" Width="100%" Font-Names="Segoe UI" KeyFieldName="MarcaID" 
                    oncustomcallback="xgrdMarca_CustomCallback" ClientInstanceName="grid" onrowdeleting="xgrdMarca_RowDeleting"                     
                    onrowvalidating="xgrdMarca_RowValidating" onrowinserting="xgrdMarca_RowInserting" onrowupdating="xgrdMarca_RowUpdating"
                    OnHtmlDataCellPrepared="xgrdMarca_HtmlDataCellPrepared" Theme="Metropolis">
                    <Columns>
                        <dx:GridViewDataTextColumn FieldName="MarcaID" Visible="false" Caption="Identifier" VisibleIndex="0">
                                            ...
                                            <table style="width:100%; padding-left:10px; padding-right:10px; padding-bottom:20px">
                                                <tr style="height:40px">
                                                    <td style="height:40px; padding-right:10px; text-align:right" colspan="2">
                                                        <dx:ASPxLabel runat="server" ID="ASPxLabel3" Text="Brands register" Font-Size="13pt" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                    </td>
                                                </tr>
                                                <tr>
