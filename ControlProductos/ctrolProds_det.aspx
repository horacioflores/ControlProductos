...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/jscript">
       ...
       function recalcular() {
           cantidad = parseFloat(document.getElementById("MainContent_ASPxCallbackPanel2_txtCantidad").value);
           precio = parseFloat(document.getElementById("MainContent_ASPxCallbackPanel2_txtPrecioU").value);
           total = cantidad * precio;
           document.getElementById("MainContent_ASPxCallbackPanel2_lblTotal").innerHTML = (Math.round(total * 100) / 100).toString();
       }
    ...
    <div class="container-fluid CeroPM">
      <dx:ASPxCallbackPanel runat="server" ID="ASPxCallbackPanel2" Width="100%" ClientInstanceName="ASPxCallbackPanel2" RenderMode="Table" OnCallback="ASPxCallbackPanel2_Callback">
            ...
            <div class="row CeroPM">
                <div class="col-xs-12">
                    <div class="col-xs-12 col-sm-8 form-group BGFormularioTitulo">
                        ...
                        <asp:Literal ID="ltlSts" runat="server"/>
<%--                     <span id="spanStatus" class="alert btn-info docEstatus" hidden><i class="glyphicon glyphicon-edit" style="padding-right:5px;"/>Abierto</span><span style="position: absolute;left: 250px;color:#FBFBFB;padding:2px 0px;" hidden>:Pendiente por el autor para terminar la captura</span>
                        <span id="spanStatus" class="alert btn-info docEstatus" hidden><i class="glyphicon glyphicon-eye-open" style="padding-right:5px;"/>Revisado</span><span style="position: absolute;left: 250px;color:#FBFBFB;padding:2px 0px;" hidden>:Revisado para su proceso</span>
                        <span id="spanStatus" class="alert btn-info docEstatus" hidden><i class="glyphicon glyphicon-lock" style="padding-right:5px;"/>Cerrado</span><span style="position: absolute;left: 250px;color:#FBFBFB;padding:2px 0px;" hidden>:Cerrado por Alejandro Gonalez el 12/10/20 2:35PM</span>
                        <span id="spanStatus" class="alert btn-warning docEstatus" hidden><i class="glyphicon glyphicon-ban-circle" style="padding-right:5px;"/>Cancelado</span><span style="position: absolute;left: 250px;color:#FBFBFB;padding:2px 0px;" hidden>:Por Alejandro Gonzalez el 12/10/20 10:02AM</span>
                        <span id="spanStatus" class="alert btn-success docEstatus" hidden><i class="glyphicon glyphicon-ok" style="padding-right:5px;"/>Aprobado</span><span style="position: absolute;left: 250px;color:#FBFBFB;padding:2px 0px;" hidden>:Aprobado el 24/10/20 08:20AM</span>
                        <span id="spanStatus" class="alert btn-primary docEstatus" hidden><i class="glyphicon glyphicon-dashboard" style="padding-right:5px;text-align:center;"/>Pendiente por aprobación</span><span style="position: absolute;left: 250px;color:#FBFBFB;padding:2px 0px;" hidden>:Pendiente por el aprobador</span>
                        <span id="spanStatus" class="alert btn-danger docEstatus"><i class="glyphicon glyphicon-remove" style="padding-right:5px;"/>Rechazado</span><span style="position: absolute;left: 250px;color:#FBFBFB;padding:2px 0px;">:Rechazado por Joel Hernandez</span>--%>
                    </div>
                    <div class="col-xs-12 col-sm-4 CeroPM" style="padding-top:3px;">
                        <div class="row form-group RowsControl">
                            ...
                            <div class="col-xs-4 " style="color:red; font-weight:800;">
                                <asp:TextBox ID="lblnDoc" runat="server" style="background-color: transparent !important;border:none;" Enabled="false"/>
                            </div>
                        </div>
                        <div class="row form-group RowsControl">
                            <label class="text-form col-xs-4" style="padding: 1px;margin: 0px;">Generador</label>
                    ...
                    <div class="panel panel-info" id="infoSolicitante">
                        ...
                        <div class="panel-body disabled">
                            <div class="row form-group CeroPM">
                                ...
                                <label id="lblProd" runat="server" class="text-form col-sm-2">Selecciona Artículo</label>
                                <div class="col-sm-4">
                                    <dx:ASPxComboBox CssClass="form-control input-sm Campos" ID="cmbProducto" runat="server" IncrementalFilteringMode="Contains"
                            ...
                            <div id="dvReemplazaOtro" runat="server" class="row form-group CeroPM">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <%--<asp:TextBox ID="remplazaOtro" runat="server" CssClass="form-control input-sm Campos"/>--%>
                                </div>
                                <label id="lblcual" runat="server" class="text-form col-sm-2">Cuál artículo</label>
                                <div class="col-sm-4">
                                    <dx:ASPxComboBox CssClass="form-control input-sm Campos" ID="cmbCualArticulo" runat="server" IncrementalFilteringMode="Contains" 
                                        FilterMinLength="0" EnableCallbackMode="True" CallbackPageSize="20" FocusedStyle-Border-BorderColor="#3399ff" Width="100%" Paddings-Padding="0px" Theme="Aqua" 
                                        PopupVerticalAlign="Above" PopupHorizontalAlign="Center" ItemStyle-SelectedStyle-Font-Italic="true">
                                        <ValidationSettings>
                                            <RequiredField  IsRequired="true" ErrorText="Select a option"/>
                                    ...
                                    <%--<asp:TextBox ID="cualArticulo" runat="server" CssClass="form-control input-sm Campos"/>--%>
                                </div>
                            </div>
                            <fieldset style="padding:10px;border: 1px solid #B5D2EA;border-radius:5px;">
                                ...
                                <div class="row form-group CeroPM">
                                    ...
                                    <div class="col-sm-11">
                                        ...
                                        <dx:ASPxComboBox CssClass="form-control input-sm Campos" ID="cmbMaquina" runat="server" IncrementalFilteringMode="Contains" 
                                            FilterMinLength="0" EnableCallbackMode="True" CallbackPageSize="20" FocusedStyle-Border-BorderColor="#3399ff" Width="105%" Paddings-Padding="0px" Theme="Aqua"  
                                            PopupVerticalAlign="Above" PopupHorizontalAlign="Center" ItemStyle-SelectedStyle-Font-Italic="true">
                                            <ValidationSettings>
                                                <RequiredField  IsRequired="true" ErrorText="Select a option"/>
                                            </ValidationSettings>
                                ...
                                <div class="row form-group CeroPM">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <dx:ASPxComboBox CssClass="form-control input-sm Campos" ID="cmbSubCat1" runat="server" IncrementalFilteringMode="Contains" 
                                            FilterMinLength="0" EnableCallbackMode="True" CallbackPageSize="20" FocusedStyle-Border-BorderColor="#3399ff" Width="100%" Paddings-Padding="0px" Theme="Aqua" 
                                            PopupVerticalAlign="Above" PopupHorizontalAlign="Center" ItemStyle-SelectedStyle-Font-Italic="true">
                                            <ValidationSettings>
                                                <RequiredField  IsRequired="true" ErrorText="Select a option"/>
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <dx:ASPxComboBox CssClass="form-control input-sm Campos" ID="cmbSubCat2" runat="server" IncrementalFilteringMode="Contains" 
                                            FilterMinLength="0" EnableCallbackMode="True" CallbackPageSize="20" FocusedStyle-Border-BorderColor="#3399ff" Width="100%" Paddings-Padding="0px" Theme="Aqua"  
                                            PopupVerticalAlign="Above" PopupHorizontalAlign="Center" ItemStyle-SelectedStyle-Font-Italic="true">
                                            <ValidationSettings>
                                                <RequiredField  IsRequired="true" ErrorText="Select a option"/>
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <dx:ASPxComboBox CssClass="form-control input-sm Campos" ID="cmbSubCat3" runat="server" IncrementalFilteringMode="Contains" 
                                            FilterMinLength="0" EnableCallbackMode="True" CallbackPageSize="20" FocusedStyle-Border-BorderColor="#3399ff" Width="100%" Paddings-Padding="0px" Theme="Aqua" 
                                            PopupVerticalAlign="Above" PopupHorizontalAlign="Center" ItemStyle-SelectedStyle-Font-Italic="true">
                                            <ValidationSettings>
                                                <RequiredField  IsRequired="true" ErrorText="Select a option"/>
                            ...
                            <div class="row form-group CeroPM" style="padding-top:10px;">
                                ...
                                <div class="col-sm-4">
                                        ...
                                        <dx:ASPxComboBox CssClass="form-control input-sm Campos" ID="cmbUtilizado" runat="server" IncrementalFilteringMode="Contains" 
                                            FilterMinLength="0" EnableCallbackMode="True" CallbackPageSize="20" FocusedStyle-Border-BorderColor="#3399ff" Width="100%" Paddings-Padding="0px" Theme="Aqua"  
                                            PopupVerticalAlign="Above" PopupHorizontalAlign="Center" ItemStyle-SelectedStyle-Font-Italic="true">
                                            <ValidationSettings>
                                                <RequiredField  IsRequired="true" ErrorText="Select a option"/>
                                ...
                                <div class="col-sm-4">
                                        ...
                                        <dx:ASPxComboBox CssClass="form-control input-sm Campos" ID="cmbDepa" runat="server" IncrementalFilteringMode="Contains" 
                                            FilterMinLength="0" EnableCallbackMode="True" CallbackPageSize="20" FocusedStyle-Border-BorderColor="#3399ff" Width="100%" Paddings-Padding="0px" Theme="Aqua"  
                                            PopupVerticalAlign="Above" PopupHorizontalAlign="Center" ItemStyle-SelectedStyle-Font-Italic="true" >
                                            <ValidationSettings>
                                                <RequiredField  IsRequired="true" ErrorText="Select a option"/>
...
<%--                            <img src="Assets/Images/New.png" alt="add without file" title="add" style="cursor: pointer;" onclick="openModal('TipoArticulo');" />
                            ...
                            <dx:ASPxGridView ID="xgrdTipoArticulo" runat="server" AutoGenerateColumns="true" Width="100%" Font-Names="Segoe UI"
                                OnCustomCallback="xgrdTipoArticulo_CustomCallback" OnHtmlDataCellPrepared="xgrdTipoArticulo_HtmlDataCellPrepared"
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Name="M" Caption="M" VisibleIndex="2" Width="10%" CellStyle-CssClass="text-center"/>
                                    <dx:GridViewDataTextColumn Name="N" Caption="N" VisibleIndex="3" Width="10%" CellStyle-CssClass="text-center">
                                        <DataItemTemplate>
                                ...
                                <div class="modal-dialog" runat="server">
                                    <div class="modal-content" runat="server">
                                        ...
                                        <div class="modal-body" runat="server">
                                            <dx:ASPxGridView ID="xgrdTipoArticuloMDL" runat="server" AutoGenerateColumns="true" Width="100%" Font-Names="Segoe UI"
                                                OnCustomCallback="xgrdTipoArticuloMDL_CustomCallback" OnHtmlDataCellPrepared="xgrdTipoArticuloMDL_HtmlDataCellPrepared"
                                                ClientInstanceName="xgrdTipoArticuloMDL" Theme="Metropolis">
                                                <Columns>
                                                    <dx:GridViewDataTextColumn Name="CheckID" VisibleIndex="0" Width="10px"/>
                                                    <dx:GridViewDataTextColumn FieldName="tipoArticulo" Caption="Tipo de Artículo" VisibleIndex="1" Width="35%"/>
                                                    <dx:GridViewDataTextColumn FieldName="M" Caption="M" VisibleIndex="2" Width="10%" CellStyle-HorizontalAlign="Center" CellStyle-CssClass="text-center"/>
                                                    <dx:GridViewDataTextColumn FieldName="N" Caption="N" VisibleIndex="3" Width="10%" CellStyle-HorizontalAlign="Center" CellStyle-CssClass="text-center"/>
                                                    <dx:GridViewDataTextColumn FieldName="comentarios" Caption="Comentarios / Justificaciones" VisibleIndex="4" Width="35%"/>
                                                </Columns>
                                                <Styles>
                                                    <AlternatingRow BackColor="#F2F2F2"/>
                            ...
                            <div class="alert alert-success center-block" style="text-align:center;padding:5px; width:50%;margin:auto;">
                                <strong>Importante!</strong> Artículo con referencia <a href="#" class="alert-link"><asp:label id="lblstock" runat="server" Text="M: Con Stock"/></a>
                            </div>
                            <hr style="border-color: #B5D2EA;"/>
                            <div class="row form-group CeroPM">
                                <label class="text-form col-sm-2">Descripción 1</label>
                                <div class="col-sm-4">
                                    <asp:TextBox ID="txtDescripcion1" runat="server" CssClass="form-control input-sm Campos"/>
                                </div>
                                <label class="text-form col-sm-2">Descripción 2</label>
                                <div class="col-sm-4">
                                    <asp:TextBox ID="txtDescripcion2" runat="server" CssClass="form-control input-sm Campos"/>
                                </div>
                            </div>
                            <div class="row form-group CeroPM">
                                <label class="text-form col-sm-2">Descripción Larga</label>
                                <div class="col-sm-10">
                                    <asp:TextBox ID="txtDescripcionLarga" runat="server" CssClass="form-control input-sm Campos"/>
                                </div>
                            </div>
                            <hr style="border-color: #B5D2EA;"/>
                            <div class="row form-group CeroPM">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <dx:ASPxComboBox CssClass="form-control input-sm Campos" ID="cmbPlan" runat="server" IncrementalFilteringMode="Contains" 
                                        FilterMinLength="0" EnableCallbackMode="True" CallbackPageSize="20" FocusedStyle-Border-BorderColor="#3399ff" Width="100%" Paddings-Padding="0px" Theme="Aqua"  
                                        PopupVerticalAlign="Above" PopupHorizontalAlign="Center" ItemStyle-SelectedStyle-Font-Italic="true">
                                        <ValidationSettings>
                                            <RequiredField  IsRequired="true" ErrorText="Select a option"/>
                                ...
                                <div class="col-sm-6">
                                    <asp:TextBox ID="txtcomoAyudarStockCero" runat="server" CssClass="form-control input-sm Campos"/>
                                </div>
                            </div>
                            <div class="row form-group CeroPM">
                                <label class="text-form col-sm-2">Función de la máquina</label>
                                <div class="col-sm-10">
                                    <asp:TextBox ID="txtfuncionMaquina" runat="server" CssClass="form-control input-sm Campos"/>
                                </div>
                            </div>
                            <hr style="border-color: #B5D2EA;" />
                            <div class="row form-group CeroPM">
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtCantidad" runat="server" onChange="recalcular();" TextMode="Number" step="0.1" CssClass="form-control input-sm Campos"/>
                                </div>
                                <label class="text-form col-sm-1">Stock Mínimo</label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtStockMin" TextMode="Number" step="0.1" runat="server" CssClass="form-control input-sm Campos"/>
                                </div>
                                <label class="text-form col-sm-1">Stock Máximo</label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtStockMax" TextMode="Number" step="0.1" runat="server" CssClass="form-control input-sm Campos"/>
                                </div>
                            </div>
                            <div class="row form-group CeroPM">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <dx:ASPxComboBox CssClass="form-control input-sm Campos" ID="cmbMarca" runat="server" IncrementalFilteringMode="Contains" 
                                        FilterMinLength="0" EnableCallbackMode="True" CallbackPageSize="20" FocusedStyle-Border-BorderColor="#3399ff" Width="100%" Paddings-Padding="0px" Theme="Aqua"  
                                        PopupVerticalAlign="Above" PopupHorizontalAlign="Center" ItemStyle-SelectedStyle-Font-Italic="true">
                                        <ValidationSettings>
                                            <RequiredField  IsRequired="true" ErrorText="Select a option"/>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <dx:ASPxComboBox CssClass="form-control input-sm Campos" ID="cmbProveedor" runat="server" IncrementalFilteringMode="Contains" 
                                        FilterMinLength="0" EnableCallbackMode="True" CallbackPageSize="20" FocusedStyle-Border-BorderColor="#3399ff" Width="100%" Paddings-Padding="0px" Theme="Aqua"  
                                        PopupVerticalAlign="Above" PopupHorizontalAlign="Center" ItemStyle-SelectedStyle-Font-Italic="true">
                                        <ValidationSettings>
                                            <RequiredField  IsRequired="true" ErrorText="Select a option"/>
                                ...
                                <div class="col-sm-2">
                                    <dx:ASPxComboBox CssClass="form-control input-sm Campos" ID="cmbUnico" runat="server" IncrementalFilteringMode="Contains" 
                                        FilterMinLength="0" EnableCallbackMode="True" CallbackPageSize="20" FocusedStyle-Border-BorderColor="#3399ff" Width="100%" Paddings-Padding="0px" Theme="Aqua"  
                                        PopupVerticalAlign="Above" PopupHorizontalAlign="Center" ItemStyle-SelectedStyle-Font-Italic="true">
                                        <ValidationSettings>
                                            <RequiredField  IsRequired="true" ErrorText="Select a option"/>
                            ...
                            <div class="row form-group CeroPM">
                                ...
                                <div class="col-sm-2">
                                    <dx:ASPxDateEdit ID="xDateFechaCot" runat="server" Width="100%"  CssClass="form-control input-sm Campos"
                                        FocusedStyle-Border-BorderColor="#3399ff" Paddings-Padding="0px" Theme="Aqua"  
                                ...
                                <div class="col-sm-2">
                                    <asp:TextBox ID="txtPrecioU" onChange="recalcular();" TextMode="Number" step="0.1" runat="server" CssClass="form-control input-sm Campos"/>
                                </div>
                                <label class="text-form col-sm-1">Días de Entrega</label>
                                <div class="col-sm-2">
                                    <asp:TextBox ID="txtDiasEntrega" TextMode="Number" step="1" runat="server" CssClass="form-control input-sm Campos"/>
                                </div>
                                <label class="text-form col-sm-1">Moneda</label>
                                <div class="col-sm-2">
                                    <input type="hidden" id="hdnCodigomoneda" value='<%# Eval("Codigomoneda")%>' runat="server"/>
                                    <dx:ASPxComboBox CssClass="form-control input-sm Campos" ID="cmbMoneda" runat="server" IncrementalFilteringMode="Contains" 
                                        FilterMinLength="0" EnableCallbackMode="True" CallbackPageSize="20" FocusedStyle-Border-BorderColor="#3399ff" Width="100%" Paddings-Padding="0px" Theme="Aqua"  
                                        PopupVerticalAlign="Above" PopupHorizontalAlign="Center" ItemStyle-SelectedStyle-Font-Italic="true">
                                        <ValidationSettings>
                                            <RequiredField  IsRequired="true" ErrorText="Select a option"/>
                            ...
                            <div class="row form-group CeroPM">
                                <h3>
                                    ...
                                    <asp:Label ID="lblTotal" runat="server" CssClass="text-form col-sm-2" style="color:green;"/>
                                </h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <dx:ASPxGridView ID="xgrdMtto" runat="server" AutoGenerateColumns="true"
                                Width="100%" Font-Names="Segoe UI" OnCustomCallback="xgrdMtto_CustomCallback"
                                OnHtmlDataCellPrepared="xgrdMtto_HtmlDataCellPrepared" ClientInstanceName="xgrdMtto" Theme="Metropolis">
                                <Columns>
                                    <dx:GridViewDataTextColumn Name="CheckID" VisibleIndex="0" Width="5%"/>
                                    <dx:GridViewDataTextColumn FieldName="especificacion" Caption="Especificación" VisibleIndex="1" Width="35%"/>
                                    <dx:GridViewDataTextColumn FieldName="notas" Caption="Notas" VisibleIndex="2" Width="20%"/>
                                    <dx:GridViewDataTextColumn FieldName="clasificacion" Caption="Clasificación" VisibleIndex="3" Width="20%"/>
                                    <dx:GridViewDataTextColumn FieldName="responsable" Caption="Responsable" VisibleIndex="4" Width="20%"/>
                                </Columns>
                                <Styles>
                                    <AlternatingRow BackColor="#F2F2F2"/>
                                    <RowHotTrack BackColor="#CEECF5"/>
                            ...
                            <div id="mdlMtto" class="modal fade" role="dialog">
                                <div class="modal-dialog" runat="server">
                                    <div class="modal-content" runat="server">
                                        ...
                                        <div class="modal-body" runat="server">
                                            <dx:ASPxGridView ID="xgrdMttoMDL" runat="server" AutoGenerateColumns="true" Width="100%" Font-Names="Segoe UI"
                                                OnCustomCallback="xgrdMttoMDL_CustomCallback" OnHtmlDataCellPrepared="xgrdMttoMDL_HtmlDataCellPrepared"
            ...
            <section id="sAlmacen" class="row CeroPM">
                <div class="col-xs-12">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <dx:ASPxGridView ID="xgrdAlmacen" runat="server" AutoGenerateColumns="true" Width="100%" Font-Names="Segoe UI"
                                OnCustomCallback="xgrdAlmacen_CustomCallback" OnHtmlDataCellPrepared="xgrdAlmacen_HtmlDataCellPrepared" ClientInstanceName="xgrdAlmacen" Theme="Metropolis">
                                <Columns>
                                    <dx:GridViewDataTextColumn Name="CheckID" VisibleIndex="0" Width="5%"/>
                                    <dx:GridViewDataTextColumn FieldName="especificacion" Caption="Especificación" VisibleIndex="1" Width="35%"/>
                                    <dx:GridViewDataTextColumn FieldName="notas" Caption="Notas" VisibleIndex="2" Width="20%"/>
                            ...
                            <div id="mdlAlmacen" class="modal fade" role="dialog">
                                <div class="modal-dialog" runat="server">
                                    <div class="modal-content" runat="server">
                                        ...
                                        <div class="modal-body" runat="server">
                                            <dx:ASPxGridView ID="xgrdAlmacenMDL" runat="server" AutoGenerateColumns="true" Width="100%" Font-Names="Segoe UI"
                                                OnCustomCallback="xgrdAlmacenMDL_CustomCallback" OnHtmlDataCellPrepared="xgrdAlmacenMDL_HtmlDataCellPrepared" ClientInstanceName="xgrdAlmacenMDL" Theme="Metropolis">
                                                <Columns>
                                                    <dx:GridViewDataTextColumn Name="CheckID" VisibleIndex="0" Width="10px"/>
            ...
            <section id="sComprador" class="row CeroPM">
                <div class="col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row form-group CeroPM">
                                <label class="text-form col-sm-2">Ficha de datos de seguridad</label>
                                <div class="col-sm-4">
                                    ...
                                    <%--<asp:TextBox ID="txtFichaSeguridad" runat="server" CssClass="form-control input-sm Campos"/>--%>
                                </div>
                                <label class="text-form col-sm-2">Unidad de Medida</label>
                                <div class="col-sm-4">
                                    <input type="hidden" id="hdnCodigoUM" value='<%# Eval("CodigoUM")%>' runat="server"/>
                                    <dx:ASPxComboBox CssClass="form-control input-sm Campos" ID="cmbCodigoUM" runat="server" IncrementalFilteringMode="Contains" 
                                        FilterMinLength="0" EnableCallbackMode="True" CallbackPageSize="20" FocusedStyle-Border-BorderColor="#3399ff" Width="100%" Paddings-Padding="0px" Theme="Aqua"  
                                        PopupVerticalAlign="Above" PopupHorizontalAlign="Center" ItemStyle-SelectedStyle-Font-Italic="true">
                                        <ValidationSettings>
                                            <RequiredField  IsRequired="true" ErrorText="Select a option"/>
                            ...
                            <div class="row form-group CeroPM">
                                <label class="text-form col-sm-2">Conteo Cíclico</label>
                                <div class="col-sm-4">
                                    <%--<asp:TextBox ID="txtConteoCiclico" runat="server" CssClass="form-control input-sm Campos"/>--%>
                                    <dx:ASPxComboBox CssClass="form-control input-sm Campos" ID="cmbConteoCiclico" runat="server" IncrementalFilteringMode="Contains" 
                                        FilterMinLength="0" EnableCallbackMode="True" CallbackPageSize="20" FocusedStyle-Border-BorderColor="#3399ff" Width="100%" Paddings-Padding="0px" Theme="Aqua" 
                                        PopupVerticalAlign="Above" PopupHorizontalAlign="Center" ItemStyle-SelectedStyle-Font-Italic="true">
                                        <ValidationSettings>
                                            <RequiredField  IsRequired="true" ErrorText="Select a option"/>
                                ...
                                <label class="text-form col-sm-2">Alacenamiento externo posbible</label>
                                <div class="col-sm-34>
                                    ...
                                    <%--<asp:TextBox ID="txtAlmacenamientoExt" runat="server" CssClass="form-control input-sm Campos"/>--%>
                                </div>
                            </div>
                            <div class="row form-group CeroPM">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <dx:ASPxComboBox CssClass="form-control input-sm Campos" ID="cmbPlaneador" runat="server" IncrementalFilteringMode="Contains" 
                                        FilterMinLength="0" EnableCallbackMode="True" CallbackPageSize="20" FocusedStyle-Border-BorderColor="#3399ff" Width="100%" Paddings-Padding="0px" Theme="Aqua"  
                                        PopupVerticalAlign="Above" PopupHorizontalAlign="Center" ItemStyle-SelectedStyle-Font-Italic="true">
                                        <ValidationSettings>
                                            <RequiredField  IsRequired="true" ErrorText="Select a option"/>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <dx:ASPxComboBox CssClass="form-control input-sm Campos" ID="cmbComprador" runat="server" IncrementalFilteringMode="Contains" 
                                        FilterMinLength="0" EnableCallbackMode="True" CallbackPageSize="20" FocusedStyle-Border-BorderColor="#3399ff" Width="100%" Paddings-Padding="0px" Theme="Aqua"  
                                        PopupVerticalAlign="Above" PopupHorizontalAlign="Center" ItemStyle-SelectedStyle-Font-Italic="true">
                                        <ValidationSettings>
                                            <RequiredField  IsRequired="true" ErrorText="Select a option"/>
                            ...
                            <div class="row form-group CeroPM">
                                <label class="text-form col-sm-2">Fecha de inventario</label>
                                <div class="col-sm-3">
                                    <dx:ASPxDateEdit ID="xDateFechaInv" runat="server" Width="100%" CssClass="form-control input-sm Campos" 
                                         FocusedStyle-Border-BorderColor="#3399ff" Paddings-Padding="0px" Theme="Aqua"  
                                        DisplayFormatString="yyyy-MM-dd" EditFormatString="yyyy-MM-dd">                                                             
                                        <TimeSectionProperties>
                                            <TimeEditProperties EditFormatString="hh:mm tt" />
                                ...
                                <label class="text-form col-sm-offset-1 col-sm-2">Múltiplo</label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtMultiplo" runat="server" TextMode="Number" step="0.1" CssClass="form-control input-sm Campos"/>
                                </div>
                            </div>
                            <div id="dvHojaSeg1" runat="server" class="row form-group CeroPM">
                               <label class="text-form col-sm-2">Hoja de seguridad</label>
                               <div class="col-sm-3">
                            ...
                            <div id="dvHojaSeg2" runat="server" class="row form-group CeroPM">
                                <div class="col-sm-6">
                                    <asp:TextBox ID="txtFile" Width="100%" Enabled="false" runat="server"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <div class="row form-group CeroPM">
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtCodigoArticulo" runat="server" CssClass="form-control input-sm Campos"/>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div id="pieForma">
            ...
            <div class="tab-content" style="padding:15px;">
                                        ...
                                        <PanelCollection>
                                            <dx:PanelContent ID="PanelContent3" runat="server">
                                                <div class="row form-group CeroPM">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <asp:TextBox ID="txtCodigoAprobacionAdd" runat="server" CssClass="form-control input-sm Campos"/>
                                                    </div>
                                                </div>
                                                <div class="row form-group CeroPM">
                                                    <label class="text-form col-sm-2">Paso</label>
                                                    <div class="col-sm-4">
                                                        <asp:TextBox ID="txtPasoAdd" runat="server" CssClass="form-control input-sm Campos"/>
                                                    </div>
                                                    <label class="text-form col-sm-2">Título</label>
                                                    <div class="col-sm-4">
                                                        <asp:TextBox ID="txtTituloAdd" runat="server" CssClass="form-control input-sm Campos"/>
                                                    </div>
                                                </div>
                                                <div class="row form-group CeroPM">
                                                    <label class="text-form col-sm-2">Puesto</label>
                                                    <div class="col-sm-4">
                                                        <dx:ASPxComboBox CssClass="form-control input-sm Campos" ID="cmbPuestoAdd" runat="server" IncrementalFilteringMode="Contains" 
                                                            FilterMinLength="0" EnableCallbackMode="True" CallbackPageSize="20" FocusedStyle-Border-BorderColor="#3399ff" Width="100%" Paddings-Padding="0px" Theme="Aqua"  
                                                            PopupVerticalAlign="Above" PopupHorizontalAlign="Center" ItemStyle-SelectedStyle-Font-Italic="true">
                                                            <ValidationSettings>
                                                                <RequiredField  IsRequired="true" ErrorText="Select a option"/>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <dx:ASPxComboBox CssClass="form-control input-sm Campos" ID="cmbEmpleadoAdd" runat="server" IncrementalFilteringMode="Contains" 
                                                            FilterMinLength="0" EnableCallbackMode="True" CallbackPageSize="20" FocusedStyle-Border-BorderColor="#3399ff" Width="100%" Paddings-Padding="0px" Theme="Aqua"  
                                                            PopupVerticalAlign="Above" PopupHorizontalAlign="Center" ItemStyle-SelectedStyle-Font-Italic="true">
                                                            <ValidationSettings>
                                                                <RequiredField  IsRequired="true" ErrorText="Select a option"/>
                                                ...
                                                <div class="row form-group CeroPM">
                                                    ...
                                                    <div class="col-sm-4">
                                                            <asp:TextBox ID="txtAccionAdd" runat="server" CssClass="form-control input-sm Campos"/>                                                 
                                                    </div>
                                                    <label class="text-form col-sm-2">Comentario</label>
                                                    <div class="col-sm-4">
                                                        <asp:TextBox ID="txtComentarioAdd" runat="server" CssClass="form-control input-sm Campos"/>  
                                                    </div>
                                                </div>
                                                </dx:PanelContent>
                                            </PanelCollection>
                ...
                <div id="menu1" class="tab-pane fade">
                    ...
                    <p><asp:TextBox ID="txtComentarios" TextMode="MultiLine" Rows="3" runat="server" CssClass="form-control input-sm Campos"/></p>
                </div>
            </div>
        </div>
        </dx:PanelContent>
