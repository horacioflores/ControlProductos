<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="CatCounts.aspx.cs" Inherits="ControlProductos.CatCounts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="Busqueda" runat="server">
        <dx:ASPxNavBar ID="ASPxNavBar2" runat="server" Theme="Metropolis" Width="100%" Font-Bold="False">
            <Groups>
                <dx:NavBarGroup Text="Counts \ Filters">
                        <ContentTemplate>
    ...
    <div id="Detalle" runat="server">
         <dx:ASPxGridView ID="xgrdConteo" runat="server" AutoGenerateColumns="False" Width="100%" Font-Names="Segoe UI" KeyFieldName="ConteoID" 
                    oncustomcallback="xgrdConteo_CustomCallback" ClientInstanceName="grid" onrowdeleting="xgrdConteo_RowDeleting"                     
                    onrowvalidating="xgrdConteo_RowValidating" onrowinserting="xgrdConteo_RowInserting" onrowupdating="xgrdConteo_RowUpdating"
                    OnHtmlDataCellPrepared="xgrdConteo_HtmlDataCellPrepared" Theme="Metropolis">
                    <Columns>
                        <dx:GridViewDataTextColumn FieldName="ConteoID" Visible="false" Caption="Identifier" VisibleIndex="0">
                                            ...
                                            <table style="width:100%; padding-left:10px; padding-right:10px; padding-bottom:20px">
                                                <tr style="height:40px">
                                                    <td style="height:40px; padding-right:10px; text-align:right" colspan="2">
                                                        <dx:ASPxLabel runat="server" ID="ASPxLabel3" Text="Counts register" Font-Size="13pt" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                    </td>
                                                </tr>
                                                <tr>
