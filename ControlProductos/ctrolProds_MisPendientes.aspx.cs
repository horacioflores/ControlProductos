...
{
    public partial class ctrolProds_MisPendientes : BasePage
    {
        ...
        public void fillGrid()
        {
            ...
            var oListProd = BCtrlProd.GetCtrlProd_MisPendientes(xDateFechaIni.Text, xDateFechaFin.Text, Folio, LoginInfo.CurrentPerfil.Codigo);
