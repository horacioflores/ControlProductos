...
{
    public partial class ctrolProds_ProductosVigentes : BasePage
    {
        ...
        public void fillGrid()
        {
            ...
            var oListProd = BCtrlProd.GetCtrlProd_ProductosVigentes(xDateFechaIni.Text, xDateFechaFin.Text, Folio, LoginInfo.CurrentUsuario.Codigo);
