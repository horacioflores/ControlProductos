<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="CatAplicaciones.aspx.cs" Inherits="ControlProductos.CatAplicaciones" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                    ...
                    <ContentTemplate>
                        <div id="Parametros" runat="server" visible="true">                            
                            <table style="float: left; width: 40%"" class="OptionsTable BottomMargin">
                                ...
                                <tr>
                                    <td  style="width:10%; text-align:left">
                                        <dx:ASPxLabel ID="lblDescripcion" runat="server" Text="Description: "></dx:ASPxLabel>
                                    </td>
                                    <td  style="width:30%; text-align:left">
    ...
    <div id="Detalle" runat="server">
        <dx:ASPxGridView ID="xgrdAplicacion" runat="server" AutoGenerateColumns="False" Width="100%" Font-Names="Segoe UI" KeyFieldName="AppId" 
            oncustomcallback="xgrdAplicacion_CustomCallback" ClientInstanceName="grid" onrowdeleting="xgrdAplicacion_RowDeleting"                     
            onrowvalidating="xgrdAplicacion_RowValidating" onrowinserting="xgrdAplicacion_RowInserting" onrowupdating="xgrdAplicacion_RowUpdating"
            OnHtmlDataCellPrepared="xgrdAplicacion_HtmlDataCellPrepared" Theme="Metropolis">
            <Columns>
                <dx:GridViewDataTextColumn FieldName="AppId" Visible="false" Caption="Identifier" VisibleIndex="0"></dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Name="CheckID" VisibleIndex="1" Width="30px"></dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="Codigo" VisibleIndex="2" Caption="Code" Width="5%"></dx:GridViewDataTextColumn>                     
                <dx:GridViewDataTextColumn FieldName="Descripcion" VisibleIndex="3" Caption="Description" Width="35%"></dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="URL" VisibleIndex="4" Caption="URL" Width="50%"></dx:GridViewDataTextColumn>
            </Columns>
                                    ...
                                    <table style="width:100%; padding-left:10px; padding-right:10px; padding-bottom:20px">
                                        <tr style="height:40px">
                                            <td style="height:40px; padding-right:10px; text-align:right" colspan="2">
                                                <dx:ASPxLabel runat="server" ID="ASPxLabel3" Text="Applications Register" Font-Size="13pt" Font-Names="Segoe UI"></dx:ASPxLabel>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td style="padding-left: 10px">
                                                <dx:ASPxLabel runat="server" ID="ASPxLabel1" Text="URL" Font-Names="Segoe UI"/>
                                            </td>
                                            <td>
                                                <dx:ASPxTextBox runat="server" ID="xtxtURLEdit" theme="SoftOrange" Width="200px" MaxLength="100" Text='<%# Eval("URL")%>' Font-Names="Segoe UI"
                                                    FocusedStyle-Border-BorderColor="#3399ff">
                                                    <ValidationSettings SetFocusOnError="true" Display="Static" CausesValidation="true">
                                                        <RegularExpression ValidationExpression="[A-Za-záéíóúñÑ,;:\.\\\/\_\-\s\d\(\)]+" ErrorText="Please enter just valid characters" />
                                                        <RequiredField IsRequired="true" ErrorText="Field Required" />
