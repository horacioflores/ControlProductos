<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="CatUsed.aspx.cs" Inherits="ControlProductos.CatUsed" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="Busqueda" runat="server">
        <dx:ASPxNavBar ID="ASPxNavBar2" runat="server" Theme="Metropolis" Width="100%" Font-Bold="False">
            <Groups>
                <dx:NavBarGroup Text="Used \ Filters">
                        <ContentTemplate>
    ...
    <div id="Detalle" runat="server">
         <dx:ASPxGridView ID="xgrdUtilizado" runat="server" AutoGenerateColumns="False" Width="100%" Font-Names="Segoe UI" KeyFieldName="UtilizadoID" 
                    oncustomcallback="xgrdUtilizado_CustomCallback" ClientInstanceName="grid" onrowdeleting="xgrdUtilizado_RowDeleting"                     
                    onrowvalidating="xgrdUtilizado_RowValidating" onrowinserting="xgrdUtilizado_RowInserting" onrowupdating="xgrdUtilizado_RowUpdating"
                    OnHtmlDataCellPrepared="xgrdUtilizado_HtmlDataCellPrepared" Theme="Metropolis">
                    <Columns>
                        <dx:GridViewDataTextColumn FieldName="UtilizadoID" Visible="false" Caption="Identifier" VisibleIndex="0">
                                            ...
                                            <table style="width:100%; padding-left:10px; padding-right:10px; padding-bottom:20px">
                                                <tr style="height:40px">
                                                    <td style="height:40px; padding-right:10px; text-align:right" colspan="2">
                                                        <dx:ASPxLabel runat="server" ID="ASPxLabel3" Text="Used register" Font-Size="13pt" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                    </td>
                                                </tr>
                                                <tr>
