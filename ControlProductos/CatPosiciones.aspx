<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="CatPosiciones.aspx.cs" Inherits="ControlProductos.CatPosiciones" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="Busqueda" runat="server">
                    <dx:ASPxNavBar ID="ASPxNavBar2" runat="server" Theme="Metropolis" Width="100%" 
                        Font-Bold="False">
                        <Groups>
                            <dx:NavBarGroup Text="Positions\ Filters">
                                    <ContentTemplate>
    ...
    <div id="Detalle" runat="server">
         <dx:ASPxGridView ID="xgrdPosicion" runat="server" AutoGenerateColumns="False" Width="100%" Font-Names="Segoe UI" KeyFieldName="PosicionId" 
                    oncustomcallback="xgrdPosicion_CustomCallback" ClientInstanceName="grid" onrowdeleting="xgrdPosicion_RowDeleting"                     
                    onrowvalidating="xgrdPosicion_RowValidating" onrowinserting="xgrdPosicion_RowInserting" onrowupdating="xgrdPosicion_RowUpdating"
             OnHtmlDataCellPrepared="xgrdPosicion_HtmlDataCellPrepared" Theme="Metropolis">
                    <Columns>
                        <dx:GridViewDataTextColumn FieldName="PosicionId" Visible="false" Caption="Identifier" VisibleIndex="0">
                        ...
                        <dx:GridViewDataTextColumn FieldName="Descripcion" VisibleIndex="3" Caption="Description" Width="35%">
                         ...
                         <dx:GridViewDataTextColumn FieldName="Nivel" VisibleIndex="4" Caption="Level" Width="50%">
                        </dx:GridViewDataTextColumn>                        
                    </Columns>
                                            ...
                                            <table style="width:100%; padding-left:10px; padding-right:10px; padding-bottom:20px">
                                                <tr style="height:40px">
                                                    <td style="height:40px; padding-right:10px; text-align:right" colspan="2">
                                                        <dx:ASPxLabel runat="server" ID="ASPxLabel3" Text="Positions register" Font-Size="13pt" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <dx:ASPxTextBox runat="server" ID="xtxtCodigoEdit" theme="SoftOrange" Width="200px" MaxLength="50" Text='<%# Eval("Codigo")%>' Font-Names="Segoe UI"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <dx:ASPxTextBox runat="server" ID="xtxtDescripcionEdit" theme="SoftOrange" Width="200px" MaxLength="100" Text='<%# Eval("Descripcion")%>' Font-Names="Segoe UI"
                                                            FocusedStyle-Border-BorderColor="#3399ff">
                                                            <ValidationSettings SetFocusOnError="true" Display="Static" CausesValidation="true">
                                                                <RegularExpression ValidationExpression="[A-Za-záéíóúñÑ,;:\.\/\_\-\s\d\(\)]+" ErrorText="Please enter just valid characters" />
                                                                <RequiredField IsRequired="true" ErrorText="Field Required" />
                                                ...
                                                <tr>
                                                    <td style="padding-left: 10px">
                                                        <dx:ASPxLabel runat="server" ID="lblNivel" Text="Level" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                        <dx:ASPxTextBox runat="server" ID="xtxtNivelEdit" theme="SoftOrange" Width="200px" MaxLength="5" Text='<%# Eval("Nivel")%>' Font-Names="Segoe UI"
                                                            FocusedStyle-Border-BorderColor="#3399ff">
                                                            <ValidationSettings SetFocusOnError="true" Display="Static" CausesValidation="true">
                                                                <RegularExpression ValidationExpression="[A-Za-záéíóúñÑ,;:\.\/\_\-\s\d\(\)]+" ErrorText="Please enter just valid characters" />
                                                                <RequiredField IsRequired="true" ErrorText="Field Required" />
