<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="CatDepto.aspx.cs" Inherits="ControlProductos.CatDepto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="Busqueda" runat="server">
                    <dx:ASPxNavBar ID="ASPxNavBar2" runat="server" Theme="Metropolis" Width="100%" 
                        Font-Bold="False">
                        <Groups>
                            <dx:NavBarGroup Text="Departments\ Filters">
                                    <ContentTemplate>
    ...
    <div id="Detalle" runat="server">
         <dx:ASPxGridView ID="xgrdDepartamento" runat="server" AutoGenerateColumns="False" 
                    Width="100%" Font-Names="Segoe UI" KeyFieldName="DeptoId" oncustomcallback="xgrdDepartamento_CustomCallback" ClientInstanceName="grid"
                    onrowdeleting="xgrdDepartamento_RowDeleting" onrowvalidating="xgrdDepartamento_RowValidating" onrowinserting="xgrdDepartamento_RowInserting" 
                    onrowupdating="xgrdDepartamento_RowUpdating" OnHtmlDataCellPrepared="xgrdDepartamento_HtmlDataCellPrepared"  Theme="Metropolis">
                    <Columns>
                        <dx:GridViewDataTextColumn FieldName="DeptoId" Visible="false" Caption="Identifier" VisibleIndex="0">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Name="CheckID" VisibleIndex="1" Width="10px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="Codigo" VisibleIndex="2" Caption="Code" Width="30%">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="Descripcion" VisibleIndex="3" Caption="Description" Width="60%">
                        </dx:GridViewDataTextColumn>
                    </Columns>
                                  ...
                                  <table style="width:100%; height:200px;">
                                     <tr style="background-repeat:repeat-x; background-image:url('Images/GreenBar.png'); vertical-align:middle">
                                        ...
                                        <td  style="height:22px; text-align:right">
                                            <img src="Assets/Images/Close.png" alt="Cerrar" title="Close" style="cursor:pointer" onclick="return grid.CancelEdit();" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="height:40px; padding-right:10px; text-align:right" colspan="2">
                                            <dx:ASPxLabel runat="server" ID="ASPxLabel1" Text="Departments Register" Font-Size="13pt" Font-Names="Segoe UI"></dx:ASPxLabel>
                                        </td>
                                    </tr>
                                    <tr>
