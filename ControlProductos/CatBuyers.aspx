<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="CatBuyers.aspx.cs" Inherits="ControlProductos.CatBuyers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="Busqueda" runat="server">
        <dx:ASPxNavBar ID="ASPxNavBar2" runat="server" Theme="Metropolis" Width="100%" Font-Bold="False">
            <Groups>
                <dx:NavBarGroup Text="Buyers \ Filters">
                        <ContentTemplate>
    ...
    <div id="Detalle" runat="server">
         <dx:ASPxGridView ID="xgrdComprador" runat="server" AutoGenerateColumns="False" Width="100%" Font-Names="Segoe UI" KeyFieldName="CompradorID" 
                    oncustomcallback="xgrdComprador_CustomCallback" ClientInstanceName="grid" onrowdeleting="xgrdComprador_RowDeleting"                     
                    onrowvalidating="xgrdComprador_RowValidating" onrowinserting="xgrdComprador_RowInserting" onrowupdating="xgrdComprador_RowUpdating"
                    OnHtmlDataCellPrepared="xgrdComprador_HtmlDataCellPrepared" Theme="Metropolis">
                    <Columns>
                        <dx:GridViewDataTextColumn FieldName="CompradorID" Visible="false" Caption="Identifier" VisibleIndex="0">
                        ...
                        <dx:GridViewDataTextColumn FieldName="Nombre" VisibleIndex="3" Caption="Name" Width="60%">
                        </dx:GridViewDataTextColumn>                   
                    </Columns>
                                            ...
                                            <table style="width:100%; padding-left:10px; padding-right:10px; padding-bottom:20px">
                                                <tr style="height:40px">
                                                    <td style="height:40px; padding-right:10px; text-align:right" colspan="2">
                                                        <dx:ASPxLabel runat="server" ID="ASPxLabel3" Text="Buyers register" Font-Size="13pt" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width:50%;">
                                                        <table style="width:100%; padding-left:0px; padding-right:0px; padding-bottom:0px; padding-top:0px">
                                                            ...
                                                            <tr>
                                                                <td style="padding-left: 10px">
                                                                    <dx:ASPxLabel runat="server" ID="lblTelefono" Text="Phone" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                                </td>
                                                                <td style="padding-left: 10px;">
                                                                    <dx:ASPxTextBox runat="server" ID="xtxtTelefonoEdit" theme="SoftOrange" Width="200px" MaxLength="15" Text='<%# Eval("Telefono")%>' Font-Names="Segoe UI"
                                                                        FocusedStyle-Border-BorderColor="#3399ff">                                                           
                                                                    </dx:ASPxTextBox>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td style="padding-left: 10px">
                                                                    <dx:ASPxLabel runat="server" ID="lblEmail" Text="E-mail" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                                </td>
                                                                <td style="padding-left: 10px;">
                                                                    <dx:ASPxTextBox runat="server" ID="xtxtEmailEdit" theme="SoftOrange" Width="200px" MaxLength="50" Text='<%# Eval("Email")%>' Font-Names="Segoe UI"
                                                                        FocusedStyle-Border-BorderColor="#3399ff">
                                                                    </dx:ASPxTextBox>
                                                                </td>
                                                            </tr>
