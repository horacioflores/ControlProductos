<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="CatMonedas.aspx.cs" Inherits="ControlProductos.CatMonedas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="Busqueda" runat="server">
                    <dx:ASPxNavBar ID="ASPxNavBar2" runat="server" Theme="Metropolis" Width="100%" 
                        Font-Bold="False">
                        <Groups>
                            <dx:NavBarGroup Text="Currency\ Filters">
                                    <ContentTemplate>
                                         <div id="Parametros" runat="server" visible="true">
                                            ...
                                            <table style="float: left; width: 40%"" class="OptionsTable BottomMargin">
                                               ...
                                               <tr>
                                                ...
                                                <tr>
                                                     <td  style="width:10%; text-align:left">
                                                             <dx:ASPxLabel ID="lblNombre" runat="server" Text="Name: ">
                                                        </dx:ASPxLabel>
                                                     </td>
                                                     <td  style="width:30%; text-align:left">
    ...
    <div id="Detalle" runat="server">
         <dx:ASPxGridView ID="xgrdMoneda" runat="server" AutoGenerateColumns="False" Width="100%" Font-Names="Segoe UI" KeyFieldName="MonedaID" 
                    oncustomcallback="xgrdMoneda_CustomCallback" ClientInstanceName="grid"
                    onrowdeleting="xgrdMoneda_RowDeleting" onrowvalidating="xgrdMoneda_RowValidating" onrowinserting="xgrdMoneda_RowInserting" 
                    onrowupdating="xgrdMoneda_RowUpdating" OnHtmlDataCellPrepared="xgrdMoneda_HtmlDataCellPrepared" Theme="Metropolis">
                    <Columns>
                        <dx:GridViewDataTextColumn FieldName="MonedaID" Visible="false" Caption="Identifier" VisibleIndex="0">
                        ...
                        <dx:GridViewDataTextColumn FieldName="Nombre" VisibleIndex="3" Caption="Name" Width="35%">
                        </dx:GridViewDataTextColumn>
                         <dx:GridViewDataTextColumn FieldName="Simbolo" VisibleIndex="4" Caption="Symbol" Width="50%">
                        </dx:GridViewDataTextColumn>
                    </Columns>
                                            ...
                                            <table style="width:100%; padding-left:10px; padding-right:10px; padding-bottom:20px">
                                                <tr style="height:40px">
                                                    <td style="height:40px; padding-right:10px; text-align:right" colspan="2">
                                                        <dx:ASPxLabel runat="server" ID="ASPxLabel3" Text="Currency register" Font-Size="13pt" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                    </td>
                                                </tr>
                                                <tr>
                                    ...
                                    <tr>
                                        <td style="vertical-align:top">
                                            <table style="width:100%; padding-left:10px; padding-right:10px; padding-bottom:20px">                                               
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <dx:ASPxTextBox runat="server" ID="xtxtNombreEdit" theme="SoftOrange" Width="200px" MaxLength="100" Text='<%# Eval("Nombre")%>' Font-Names="Segoe UI"
                                                            FocusedStyle-Border-BorderColor="#3399ff">
                                                            <ValidationSettings SetFocusOnError="true" Display="Static" CausesValidation="true">
                                                                <RegularExpression ValidationExpression="[A-Za-záéíóúñÑ,;:\.\/\_\-\s\d\(\)]+" ErrorText="Please enter just valid characters" />
                                                                <RequiredField IsRequired="true" ErrorText="Field Required" />
                                                ...
                                                <tr>
                                                    <td style="padding-left: 10px">
                                                        <dx:ASPxLabel runat="server" ID="ASPxLabel1" Text="Symbol" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                        <dx:ASPxTextBox runat="server" ID="xtxtSimboloEdit" theme="SoftOrange" Width="200px" MaxLength="100" Text='<%# Eval("Simbolo")%>' Font-Names="Segoe UI"
                                                            FocusedStyle-Border-BorderColor="#3399ff">
                                                            <ValidationSettings SetFocusOnError="true" Display="Static" CausesValidation="true">
                                                                <RequiredField IsRequired="true" ErrorText="Field Required" />
                                                            </ValidationSettings>                                                            
                                        ...
                                        <td style="vertical-align:top">
                                            <table style="width:100%; padding-left:10px; padding-right:10px; padding-bottom:20px">
                                                ...
                                                <tr>
                                                    <td style="padding-left: 10px">
                                                        <dx:ASPxLabel runat="server" ID="ASPxlblPresicion" Text="Precision" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                        <dx:ASPxSpinEdit ID="ASPxtxtPresicion" runat="server" DecimalPlaces="2" theme="SoftOrange" Width="200px" Text='<%# Eval("precs")%>' Font-Names="Segoe UI"
                                                            FocusedStyle-Border-BorderColor="#3399ff">  
                                                ...
                                                <tr>
                                                    <td style="padding-left: 10px">
                                                        <dx:ASPxLabel runat="server" ID="ASPxlblSepMillar" Text="Millar separator" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                        <dx:ASPxTextBox runat="server" ID="ASPxtxtSepMillar" theme="SoftOrange" Width="200px" MaxLength="1" Text='<%# Eval("sep_millar")%>' Font-Names="Segoe UI"
                                                            FocusedStyle-Border-BorderColor="#3399ff">
                                                            <ValidationSettings SetFocusOnError="true" Display="Static" CausesValidation="true">
                                                                <RegularExpression ValidationExpression="[A-Za-záéíóúñÑ,;:\.\/\_\-\s\d\(\)]+" ErrorText="Please enter just valid characters" />
                                                                <RequiredField IsRequired="true" ErrorText="Field Required" />
                                                ...
                                                <tr>
                                                    <td style="padding-left: 10px">
                                                        <dx:ASPxLabel runat="server" ID="ASPxLabel4" Text="Decimal separator" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                        <dx:ASPxTextBox runat="server" ID="ASPxtxtSepDecimal" theme="SoftOrange" Width="200px" MaxLength="1" Text='<%# Eval("sep_decimal")%>' Font-Names="Segoe UI"
                                                            FocusedStyle-Border-BorderColor="#3399ff">
                                                            <ValidationSettings SetFocusOnError="true" Display="Static" CausesValidation="true">
                                                                <RegularExpression ValidationExpression="[A-Za-záéíóúñÑ,;:\.\/\_\-\s\d\(\)]+" ErrorText="Please enter just valid characters" />
                                                                <RequiredField IsRequired="true" ErrorText="Field Required" />
