<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="CatSubcategory3.aspx.cs" Inherits="ControlProductos.CatSubcategory3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="Busqueda" runat="server">
        <dx:ASPxNavBar ID="ASPxNavBar2" runat="server" Theme="Metropolis" Width="100%" Font-Bold="False">
            <Groups>
                <dx:NavBarGroup Text="SubCategorys 3 \ Filters">
                        <ContentTemplate>
    ...
    <div id="Detalle" runat="server">
         <dx:ASPxGridView ID="xgrdSubcategoria3" runat="server" AutoGenerateColumns="False" Width="100%" Font-Names="Segoe UI" KeyFieldName="Subcategoria3ID" 
                    oncustomcallback="xgrdSubcategoria3_CustomCallback" ClientInstanceName="grid" onrowdeleting="xgrdSubcategoria3_RowDeleting"                     
                    onrowvalidating="xgrdSubcategoria3_RowValidating" onrowinserting="xgrdSubcategoria3_RowInserting" onrowupdating="xgrdSubcategoria3_RowUpdating"
                    OnHtmlDataCellPrepared="xgrdSubcategoria3_HtmlDataCellPrepared" OnHtmlEditFormCreated="xgrdSubcategoria3_HtmlEditFormCreated" Theme="Metropolis">
                    <Columns>
                        <dx:GridViewDataTextColumn FieldName="Subcategoria3ID" Visible="false" Caption="Identifier" VisibleIndex="0">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Name="CheckID" VisibleIndex="1" Width="10px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="Codigo" VisibleIndex="2" Caption="Code" Width="10%">
                        </dx:GridViewDataTextColumn>                     
                        <dx:GridViewDataTextColumn FieldName="Nombre" VisibleIndex="3" Caption="Name" Width="20%">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="CodigoSubcategoria1" VisibleIndex="4" Caption="Subcategory1 Code" Width="10%">
                        </dx:GridViewDataTextColumn>  
                        <dx:GridViewDataTextColumn FieldName="Subcategoria1" VisibleIndex="5" Caption="Subcategory1" Width="20%">
                        </dx:GridViewDataTextColumn>       
                        <dx:GridViewDataTextColumn FieldName="CodigoSubcategoria2" VisibleIndex="6" Caption="Subcategory2 Code" Width="10%">
                        </dx:GridViewDataTextColumn>  
                        <dx:GridViewDataTextColumn FieldName="Subcategoria2" VisibleIndex="7" Caption="Subcategory2" Width="20%">
                        </dx:GridViewDataTextColumn>                                                                                     
                    </Columns>
                                            ...
                                            <table style="width:100%; padding-left:10px; padding-right:10px; padding-bottom:20px">
                                                <tr style="height:40px">
                                                    <td style="height:40px; padding-right:10px; text-align:right" colspan="2">
                                                        <dx:ASPxLabel runat="server" ID="ASPxLabel3" Text="Subcategory3 register" Font-Size="13pt" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width:50%;">
                                                        <table style="width:100%; padding-left:0px; padding-right:0px; padding-bottom:0px; padding-top:0px">
                                                            ...
                                                            <tr>
                                                                <td style="padding-left: 10px">
                                                                    <dx:ASPxLabel runat="server" ID="ASPxSubcategoria2" Text="Subcategory2" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                                </td>
                                                                <td style="padding-left: 10px;">
                                                                    <input type="hidden" id="hdnCodigoSubcategoria2" value='<%# Eval("CodigoSubcategoria2")%>' runat="server"/>
                                                                    <dx:ASPxComboBox CssClass="form-control" ID="cmbSubcategoria2Edit" runat="server" FocusedStyle-Border-BorderColor="#3399ff" Width="200px"
                                                                    Font-Names="Segoe UI" IncrementalFilteringMode="Contains" FilterMinLength="0" EnableCallbackMode="True" OnDataBound="cmbSubcategoria2Edit_DataBound" CallbackPageSize="20" Theme="SoftOrange"
                                                                     PopupVerticalAlign="Above" PopupHorizontalAlign="Center" ItemStyle-SelectedStyle-Font-Italic="true">
                                                                        <ValidationSettings>
                                                                            <RequiredField  IsRequired="true" ErrorText="Select a option"/>
                                                                        </ValidationSettings>
